...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="900" height="240" viewBox="0 0 900 240" role="img" aria-labelledby="title desc"><title id="title">Technical stack</title><desc id="desc">Go, Python, PostgreSQL, Kafka, RabbitMQ, Docker, SQLite and Prometheus.</desc><rect width="900" height="240" rx="10" fill="#000" stroke="#fff"/><text x="22" y="36" fill="#fff" font-family="Arial, sans-serif" font-size="20" font-weight="700">TECH STACK</text><text x="22" y="55" fill="#00e5ff" font-family="Arial, sans-serif" font-size="11" font-weight="700" letter-spacing="1.2">BACKEND TOOLKIT</text><path d="M22 61H878" stroke="#333"/>${cards}</svg>\n`;
